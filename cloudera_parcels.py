...
options:
    ...
    version:
        description:
            - The version of the parcel you want to manipulate
        required: true
    state:
        description:
...
def build_module():
    fields = {
        ...
        "version": {"required": True, "tye": "str"},
        "state": {
            "default": "present",
            "choices": ['present', 'distributed', 'activated', 'absent'],
            "type": 'str'
        }
    }
...
def main():
	module = build_module()
	choice_map = {'present': present, 'distributed': distributed, 'activated': activated, 'absent': absent}
	...
	try:
		parcel = cluster.get_parcel(params["product"], params["version"])
	except ApiException as e:
